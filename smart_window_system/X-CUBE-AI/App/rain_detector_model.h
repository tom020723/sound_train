...
#ifndef AI_RAIN_DETECTOR_MODEL_H
#define AI_RAIN_DETECTOR_MODEL_H
#pragma once

#include "rain_detector_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_RAIN_DETECTOR_MODEL_MODEL_NAME          "rain_detector_model"
#define AI_RAIN_DETECTOR_MODEL_ORIGIN_MODEL_NAME   "rain_detector_int8"

/******************************************************************************/
#define AI_RAIN_DETECTOR_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_RAIN_DETECTOR_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_RAIN_DETECTOR_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_RAIN_DETECTOR_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_RAIN_DETECTOR_MODEL_IN \
  ai_rain_detector_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_RAIN_DETECTOR_MODEL_IN_SIZE { \
  AI_RAIN_DETECTOR_MODEL_IN_1_SIZE, \
}
...
AI_DEPRECATED
#define AI_RAIN_DETECTOR_MODEL_OUT \
  ai_rain_detector_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_RAIN_DETECTOR_MODEL_OUT_SIZE { \
  AI_RAIN_DETECTOR_MODEL_OUT_1_SIZE, \
}
#define AI_RAIN_DETECTOR_MODEL_OUT_SIZE_BYTES { \
  AI_RAIN_DETECTOR_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_RAIN_DETECTOR_MODEL_OUT_1_CHANNEL     (2)
#define AI_RAIN_DETECTOR_MODEL_OUT_1_SIZE        (2)
 ...
 * @ref ai_rain_detector_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_rain_detector_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_rain_detector_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_rain_detector_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_RAIN_DETECTOR_MODEL_*
 * defines into file @ref rain_detector_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_rain_detector_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_RAIN_DETECTOR_MODEL_H */
